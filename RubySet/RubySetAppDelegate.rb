...
class AppDelegate < OSX::NSObject
  ...
  def applicationSupportFolder
    OSX.NSHomeDirectory.stringByAppendingPathComponent(File.join('Library', 'Application Support', 'RubySet'))
  end
  ...
  def managedObjectContext
    ...
    url = OSX::NSURL.fileURLWithPath(storeFolder.stringByAppendingPathComponent("RubySet.xml"))
